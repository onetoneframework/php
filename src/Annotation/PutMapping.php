...
{
    /** @var string The path pattern for the route (e.g., "/users/{id}"). */
    public string $value;
    /** @var string The host pattern for the route (default is "*", which matches any host). */
    public string $host;
    /** @var int The priority of the route (higher values are matched first, default is 0). */
    public int $priority;
    /** 
