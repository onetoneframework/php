...
/**
 * AbsoluteLyrics.com unsynced lyric client
 * Slug rules: spaces replaced with underscores
 */
class AbsoluteLyrics
{
    private const BASE_URL = "http://www.absolutelyrics.com/lyrics/view";
    private const TIMEOUT = 5000;

    /**
     * Normalize text to match AbsoluteLyrics URL format
     * Strips brackets, special chars, replaces spaces with underscores
     *
     * @param string $text Raw metadata string
     * @return string Underscore-separated slug
     */
    ...
    public function request(string $artist, string $title): string
    {
        ...
        try {
            ...
            throw new Exception("AbsoluteLyrics request failed: " . $e->getMessage());
        }
    }
