...
/**
 * Genius.com unsynced lyric client
 * URL format: https://genius.com/{artist}-{title}-lyrics
 */
class GeniusLyrics
{
    private const BASE_URL = "https://genius.com";
    ...
    public function request(string $artist, string $title): string
    {
        ...
        try {
            ...
            throw new Exception("Genius request failed: " . $e->getMessage());
        }
    }

    /**
     * Build the canonical Genius lyric page URL without fetching it
     *
     * @param string $artist Artist name
     * @param string $title Song title
