...
class Client
{
    ...
    public function __construct(string|StringObject $apiKey, string|Model $model = 'goose-3')
    {
        $this->apiKey = $apiKey;
    ...
    {
        $profileUrl = "https://api.goose.ai/v1/chat/completions";
