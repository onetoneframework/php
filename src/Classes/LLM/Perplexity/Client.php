 ...
 * Class Client
 *
 * Client for interacting with the Perplexity LLM API.
 *
...
class Client
{
     ...
     */
    public function __construct(string|StringObject $apiKey, string|StringObject $model = 'llama-3.1-sonar-small-128k-online')
    {
    ...
    /**
     * Request a prompt completion from the Perplexity API.
     *
