...
use Clover\Classes\LLM\Qwen\ResponseBody;
use Clover\Enumeration\Qwen\Model;
use Exception;

/**
 * Class Client
 *
 * A client for interacting with the Qwen LLM API.
 *
...
class Client
{
     ...
     */
    public function __construct(string|StringObject $apiKey, string|Model $model = 'qwen-coder-turbo-latest')
    {
        $this->apiKey = $apiKey;
    ...
    /**
     * Set the temperature for the responses.: void
     *
    ...
    /**
     * Request a prompt completion from the Qwen API.
     *
    ...
    {
        $profileUrl = "https://dashscope.aliyuncs.com/compatible-mode/v1/chat/completions";
